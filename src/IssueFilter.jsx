...
import { Button, ButtonToolbar, FormGroup, FormControl, ControlLabel, InputGroup, Row, Col, } from 'react-bootstrap';
      ...
      <Row>
        ...
        <Col xs={6} sm={4} md={3} lg={2}>
          <FormGroup>
            ...
            <Button bsStyle="danger" type="button" onClick={this.showOriginalFilter} disabled={!changed}>Reset</Button>
            </ButtonToolbar>
          </FormGroup>
        </Col>  
      </Row>
